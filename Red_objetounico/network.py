...
# ---------- parámetros ----------
tfrecord_train_pattern = "data_jps_singleobj/train_jps_*.tfrecord"
tfrecord_test_pattern  = "data_jps_singleobj/test_jps_*.tfrecord"
...
def parse_tfrecord(example_proto):
    ...
    # target = target / 255.0 # Comentar si el target ya está normalizado
