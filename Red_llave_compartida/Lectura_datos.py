...
tfrecord_pattern = "C:\Proyectos\Prueba-red\Red_llave_compartida\data_jps_singlekey/train_jps_*.tfrecord"
...
for i in range(num_show):
    ...
    plt.imsave(f"C:\Proyectos\Prueba-red\Red_llave_compartida\input{i}.png", jps, cmap="gray") 

    mnist = tf.io.decode_raw(parsed['mnist_raw'], tf.float32)
    mnist = tf.reshape(mnist, (28, 28)).numpy()
    plt.imsave(f"C:\Proyectos\Prueba-red\Red_llave_compartida\mnist{i}.png", mnist, cmap="gray") 
