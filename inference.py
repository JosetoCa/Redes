...
INPUT_PATH = "C:\Proyectos\Prueba-red\input_letra.png"                 # archivo de entrada (cambiar según necesites)
OUTPUT_PATH = "C:\Proyectos\Prueba-red\output_letra.png"             # archivo a escribir con la predicción
